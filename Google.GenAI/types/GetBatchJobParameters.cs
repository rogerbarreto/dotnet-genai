...
namespace Google.GenAI.Types {
  ...
  internal record GetBatchJobParameters {
    ...
    /// <returns>The deserialized GetBatchJobParameters object, or null if deserialization
    /// fails.</returns>
    public static GetBatchJobParameters
        ? FromJson(string jsonString, JsonSerializerOptions? options = null) {
      try {
        return JsonSerializer.Deserialize<GetBatchJobParameters>(jsonString, options);
