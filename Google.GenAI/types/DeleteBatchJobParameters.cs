...
namespace Google.GenAI.Types {
  ...
  internal record DeleteBatchJobParameters {
    ...
    /// <returns>The deserialized DeleteBatchJobParameters object, or null if deserialization
    /// fails.</returns>
    public static DeleteBatchJobParameters
        ? FromJson(string jsonString, JsonSerializerOptions? options = null) {
      try {
        return JsonSerializer.Deserialize<DeleteBatchJobParameters>(jsonString, options);
