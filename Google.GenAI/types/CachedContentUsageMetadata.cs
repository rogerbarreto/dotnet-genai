...
namespace Google.GenAI.Types {
  ...
  public record CachedContentUsageMetadata {
    /// <summary>
    ...
    /// <returns>The deserialized CachedContentUsageMetadata object, or null if deserialization
    /// fails.</returns>
    public static CachedContentUsageMetadata
        ? FromJson(string jsonString, JsonSerializerOptions? options = null) {
      try {
        return JsonSerializer.Deserialize<CachedContentUsageMetadata>(jsonString, options);
