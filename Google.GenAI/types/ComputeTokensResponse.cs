...
namespace Google.GenAI.Types {
  ...
  public record ComputeTokensResponse {
    ...
    /// <returns>The deserialized ComputeTokensResponse object, or null if deserialization
    /// fails.</returns>
    public static ComputeTokensResponse
        ? FromJson(string jsonString, JsonSerializerOptions? options = null) {
      try {
        return JsonSerializer.Deserialize<ComputeTokensResponse>(jsonString, options);
